...
from rag.preprocess.lexicon_matcher import apply_synonym_filter, extract_aho_keywords
    ...
    def test_print_preprocessing_flow(self) -> None:
        for query in _trace_queries():
            with self.subTest(query=query):
                ...
                aho_keywords = extract_aho_keywords(lexical_query)
                ...
                self.assertEqual(state.normalized_query, normalized_query)
                self.assertEqual(understanding["lexical_query"], lexical_query)
